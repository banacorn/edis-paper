...
%% Supplied to authors by publisher for camera-ready submission
\acmConference[TyDe'17]{2nd Workshop on Type-Driven Development}{September 3, 2017}{Oxford, UK}
\acmYear{2017}
...
\author{Ting--Yan Lai}
\authornote{Ting--Yan Lai was summer intern from 
...
\keywords{Haskell, Redis, Dependent Type, Type Safety, Key-Value Store}  
