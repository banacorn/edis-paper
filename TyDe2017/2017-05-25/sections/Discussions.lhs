...
\paragraph{Returning Inferrable Types.} \texttt{GET} is yet another command that
...
Enforcing a typing discipline rules out some erroneous programs, and reduces the number of programs that are allowed. Like all type
...
different types of data, encoded as strings, and still work well.
