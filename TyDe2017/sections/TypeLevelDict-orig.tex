...
\>[20]{}\Varid{x})\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs})\;\Varid{k}{}\<[33]%
\>[33]{}\mathrel{=}{}\<[33E]%
\>[36]{}\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Set}\;(\mbox{\textquotesingle}(\Varid{k},\Varid{y})\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs})\;{}\<[29]%
\>[29]{}\Varid{k}\;\Varid{x}\mathrel{=}\mbox{\textquotesingle}(\Varid{k},\Varid{x}){}\<[48]%
\>[48]{}\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\>[48]{}\mathbin{\mbox{\textquotesingle}\!:}\Conid{Set}\;\Varid{xs}\;\Varid{k}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Del}\;(\mbox{\textquotesingle}(\Varid{k},\Varid{y})\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs})\;{}\<[30]%
\>[30]{}\Varid{k}\mathrel{=}\Varid{xs}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Del}\;(\mbox{\textquotesingle}(\Varid{t},\Varid{y})\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs})\;{}\<[30]%
\>[30]{}\Varid{k}\mathrel{=}\mbox{\textquotesingle}(\Varid{t},\Varid{y})\mathbin{\mbox{\textquotesingle}\!:}\Conid{Del}\;\Varid{xs}\;\Varid{k}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Member}\;(\mbox{\textquotesingle}(\Varid{k},\Varid{x})\mathbin{\mbox{\textquotesingle}\!:}\Varid{xs})\;{}\<[33]%
