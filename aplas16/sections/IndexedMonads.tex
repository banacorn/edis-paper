...
Class \ensuremath{\Conid{IMonad}} comes with two operations: \ensuremath{\Varid{unit}} for identities and \ensuremath{\Varid{bind}} for
compositions, as in monads.

We define a new datatype \ensuremath{\Conid{Popcorn}}, which is basically just
 the context \ensuremath{\Conid{Redis}} indexed with more information in types.
 We make it an instance of \ensuremath{\Conid{IMonad}}.
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{newtype}\;\Conid{Popcorn}\;\Varid{p}\;\Varid{q}\;\Varid{a}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Popcorn}\;\{\mskip1.5mu \Varid{unPopcorn}\mathbin{::}\Conid{Redis}\;\Varid{a}\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{bind}\;\Varid{m}\;\Varid{f}\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Conid{Popcorn}\;(\Varid{unPopcorn}\;\Varid{m}\bind \Varid{unPopcorn}\mathbin{\cdot}\Varid{f}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

The first and second argument of type \ensuremath{\Conid{Popcorn}} is where the
dictionaries going to be.

To execute a \ensuremath{\Conid{Popcorn}} program, simply apply it to
 \ensuremath{\Varid{unPopcorn}} to get an ordinary Hedis program back,
