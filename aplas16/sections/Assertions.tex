...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\to \Conid{Edis}\;\Varid{xs}\;(\Conid{Set}\;\Varid{xs}\;\Varid{s}\;\Varid{x})\;(){}\<[E]%
\\
...
\\
\>[B]{}\Varid{start}\mathbin{::}\Conid{Edis}\mathbin{’}[\mskip1.5mu \mskip1.5mu]\mathbin{’}[\mskip1.5mu \mskip1.5mu]\;(){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{result}\leftarrow \Varid{runRedis}\;\Varid{conn}\mathbin{\$}\Varid{unEdis}\mathbin{\$}\Varid{start}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
