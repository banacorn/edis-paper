...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\to \Conid{Edis}\;\Varid{xs}\;(\Conid{Del}\;\Varid{xs}\;\Varid{s})\;(\Conid{Either}\;\Conid{Reply}\;\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{del}\;\Varid{key}\mathrel{=}\Conid{Edis}\mathbin{\$}\Varid{\Conid{Hedis}.del}\;(\Varid{encodeKey}\;\Varid{key}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
