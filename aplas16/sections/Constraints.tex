...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Conid{Popcorn}\mathbin{\$}\Varid{\Conid{Hedis}.llen}\;(\Varid{encodeKey}\;\Varid{key}){}\<[E]%
\ColumnHook
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\to \Conid{Popcorn}\;\Varid{xs}\;\Varid{xs}\;(\Conid{Either}\;\Conid{Reply}\;\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{llen}\;\Varid{key}\mathrel{=}\Conid{Popcorn}\mathbin{\$}\Varid{\Conid{Hedis}.llen}\;(\Varid{encodeKey}\;\Varid{key}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
